...
from app.infrastructure.adapters.base import BaseAdapter, ConnectionError
...
def _register_builtin_adapters():
    ...
    # DuckDB
    try:
        from app.infrastructure.adapters.duckdb_adapter import DuckDBAdapter
    ...
    # Snowflake
    try:
        from app.infrastructure.adapters.snowflake_adapter import SnowflakeAdapter
    ...
    # BigQuery
    try:
        from app.infrastructure.adapters.bigquery_adapter import BigQueryAdapter
    ...
    # Databricks
    try:
        from app.infrastructure.adapters.databricks_adapter import DatabricksAdapter
    ...
    # ClickHouse
    try:
        from app.infrastructure.adapters.clickhouse_adapter import ClickHouseAdapter
    ...
    # Redshift
    try:
        from app.infrastructure.adapters.redshift_adapter import RedshiftAdapter
    ...
    # MySQL
    try:
        from app.infrastructure.adapters.mysql_adapter import MySQLAdapter
    ...
    # Trino / Presto
    try:
        from app.infrastructure.adapters.trino_adapter import TrinoAdapter, PrestoAdapter
    ...
    try:
        from app.infrastructure.adapters.sqlserver_adapter import SQLServerAdapter, MSSQLAdapter, AzureSQLAdapter
    ...
    try:
        from app.infrastructure.adapters.oracle_adapter import OracleAdapter, OracleDBAdapter, OCIAdapter, ATPAdapter, ADWAdapter
    ...
    try:
        from app.infrastructure.adapters.sqlite_adapter import SQLiteAdapter, SQLite3Adapter
    ...
    try:
        from app.infrastructure.adapters.timescaledb_adapter import TimescaleDBAdapter, TSDBAdapter, TimeScaleAdapter
    ...
    try:
        from app.infrastructure.adapters.cockroachdb_adapter import CockroachDBAdapter, CRDBAdapter, RoachAdapter
