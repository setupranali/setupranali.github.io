...
from app.shared.utils.crypto import encrypt_config, decrypt_config, mask_sensitive_config
...
# Database path - stored in data/db/ directory (outside app/)
_DB_DIR = Path(__file__).parent.parent.parent.parent / "data" / "db"
