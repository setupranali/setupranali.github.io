...
|----------|---------|------------|--------|
| PostgreSQL | `postgres_adapter.py` | `"` | ✅ |
| MySQL | `mysql_adapter.py` | `` ` `` | ✅ |
| StarRocks | `mysql_adapter.py` | `` ` `` | ✅ |
| ClickHouse | `clickhouse_adapter.py` | `` ` `` | ✅ |
| Snowflake | `snowflake_adapter.py` | `"` | ✅ |
| BigQuery | `bigquery_adapter.py` | `` ` `` | ✅ |
| DuckDB | `duckdb_adapter.py` | `"` | ✅ |
| Redshift | `redshift_adapter.py` | `"` | ✅ |
| Trino | `trino_adapter.py` | `"` | ✅ |
| Databricks | `databricks_adapter.py` | `` ` `` | ✅ |
| SQL Server | `sqlserver_adapter.py` | `[` | ✅ |
| Oracle | `oracle_adapter.py` | `"` | ✅ |
...
4. **Bi-directional Sync**: YAML contracts ↔ Semantic models stay in sync
